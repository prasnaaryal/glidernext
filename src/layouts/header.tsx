      ...
      <Container maxWidth="xl">
        <Toolbar disableGutters sx={{ justifyContent: "space-between" }}>
          ...
          <Box sx={{ display: { xs: "none", md: "flex" }, gap: 3 }}>
            {pages.map((page) => (
              <Button key={page} sx={{ color: "#333", fontWeight: "bold", fontSize: "1rem" }}>
                {page}
              </Button>
            ))}
          </Box>
          ...
          <Box sx={{ display: "flex", alignItems: "center", gap: 2 }}>
            ...
            <Image src={Call} alt="call" width={50} height={50} />
              <Typography sx={{ color: "#333", fontWeight: "bold" }}>+977-9812345678</Typography>
            </Box>

            {/* Login Button */}
            <Button sx={{ color: "#2E7D32", fontWeight: "bold", textTransform: "none" }}>Login</Button>
          </Box>
        </Toolbar>
      </Container>
    </AppBar>
